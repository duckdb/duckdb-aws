...
##
# Two related uses of this script:
# - update your shell env directly:
#   . scripts/set_s3_test_server_variables.sh
# - execute a command with this env:
#   scripts/set_s3_test_server_variables.sh build/debug/unittest 'test/sql/*'
